...
### tSNE
* See notebook #6 and visualization
...
---
# Deep learning with Floyd
In the repo 
```
floyd loging
floyd init myProj
floyd run --mode jupyter --env tensorflow-1.0:py2 --gpu
```
...
```bash
source activate tensorflow  (does not work, skip)
```

The AMI id is ami-125b2c72
...
You can launch this AMI by going to https://console.aws.amazon.com/ec2/v2/home?region=us-east-1#LaunchInstanceWizard:ami=ami-125b2c72
